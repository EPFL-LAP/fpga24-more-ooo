...
static map<BlockType,string> blockShapes = {
    {ELASTIC_BUFFER," shape=box, style=filled, fillcolor=darkolivegreen3, height=0.4"}, //height = 0.4"},
    {FORK, " shape=oval"},
    {BRANCH, " shape=oval"},
    {MERGE, " shape=oval"},
    {MUX, " shape=oval"},
    {LOOPMUX, " shape=oval"},
    {SYNCH, " shape=oval"},
    {ROB, " shape=oval"},  // AYA: 07/08/2023
    {TAGGER, "shape=oval"},  // AYA: 17/09/2023
    {UNTAGGER, "shape=oval"},
    {FREE_TAGS_FIFO, "shape=oval"},
    {ALIGNER_BRANCH, "shape=oval"},
    {ALIGNER_MUX, "shape=oval"},
    {TMFO, " shape=oval"},   // AYA: 14/05/2023: experimenting
    {CNTRL_MG, " shape=oval"},
    {SELECT, " shape=oval"},
    {OPERATOR, " shape=oval"},
