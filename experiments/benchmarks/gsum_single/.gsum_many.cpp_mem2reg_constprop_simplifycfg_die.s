	...
	.p2align	2               # -- Begin function _Z9gsum_manyPf
.LCPI0_0:
...
.LCPI0_3:
	...
	.text
	.globl	_Z9gsum_manyPf
	.p2align	4, 0x90
	.type	_Z9gsum_manyPf,@function
_Z9gsum_manyPf:                         # @_Z9gsum_manyPf
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
...
# %bb.4:                                # %for.end
	...
	retq
.Lfunc_end0:
	.size	_Z9gsum_manyPf, .Lfunc_end0-_Z9gsum_manyPf
	.cfi_endproc
                                        # -- End function
